...
| **Advanced team stats** *(planned UI)* | `/stats/teams` · `GET /api/team-advanced-stats` *(planned)* | wOBA, xwOBA, ISO, BABIP, barrel%, hard%; FIP, xFIP, K%, BB%, HR/FB | FanGraphs Parquet (`data/processed/fangraphs/`) |
...
| `GET` | `/api/team-advanced-stats` *(planned)* | `season` | FanGraphs advanced team metrics |
...
| Sabermetrics dashboard — advanced team/player stats UI | planned |
